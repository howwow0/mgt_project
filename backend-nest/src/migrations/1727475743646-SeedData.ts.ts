...
VALUES (
    ...
    1000.00,    -- Пример утреннего трафика 
    1200.00,    -- Пример вечернего трафика 
    2400        -- Пример пропускной способности 
);
...
VALUES (
    ...
    800.00,     -- Пример утреннего трафика
    1000.00,    -- Пример вечернего трафика 
    150        -- Пример пропускной способности 
);
...
VALUES (
    ...
    1200.00,    -- Пример утреннего трафика 
    1400.00,    -- Пример вечернего трафика
    300        -- Пример пропускной способности 
);
